      ...
      <div className="container px-4 py-5" id="custom-cards">
        ...
        <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          ...
          <div className="col" data-aos="fade-up">
            <a
              href="https://to-do-list-seven-teal-71.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-decoration-none"
            >
              <div className="card card-cover h-100 overflow-hidden text-dark bg-success rounded-5 shadow-lg">
                <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                  <h2 className="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold text-dark" data-aos="flip-right">To Do List</h2>
                  <ul className="d-flex list-unstyled mt-auto">
                    <li className="me-auto">
                      <img src={to_do_list} alt="To Do List" width="32" height="32" className="rounded-circle border border-white" />
                    </li>
                    <li className="d-flex align-items-center me-3">
                      <small className="text-dark">To do list</small>
                    </li>
          ...
          <div className="col" data-aos="fade-down">
            <a
              href="https://number-guessing-sooty.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-decoration-none"
            >
              <div className="card card-cover h-100 overflow-hidden text-dark bg-primary rounded-5 shadow-lg">
                <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                  <h2 className="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold text-dark" data-aos="flip-left">Number Guessing</h2>
                  <ul className="d-flex list-unstyled mt-auto">
                    <li className="me-auto">
                      <img src={numbergussing} alt="Number Guessing" width="32" height="32" className="rounded-circle border border-white" />
                    </li>
                    <li className="d-flex align-items-center me-3">
                      <small className="text-dark">Number guessing</small>
                    </li>
          ...
          {/* Coming Soon */}
          <div className="col" data-aos="fade-up">
            <div className="card card-cover h-100 overflow-hidden text-dark bg-secondary rounded-5 shadow-lg">
              <div className="d-flex flex-column h-100 p-5 pb-3 text-shadow-1">
                <h2 className="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold text-dark" data-aos="flip-right">Coming soon...</h2>
              </div>
            </div>
